...
public class DeadlineCommandTest {
    ...
    public void execute_addValidDeadlineUnfilteredList_success() throws ParseException {
        ...
        DeadlineCommand deadlineCommand = new DeadlineCommand(INDEX_FIRST_PERSON, editedPerson.getDeadlines());
    ...
    @Test
    public void execute_addValidDeadlineFilteredList_success() throws ParseException {
    ...
    @Test
    public void execute_addInvalidDeadline_throwsParseException() throws ParseException {
        Person firstPerson = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
