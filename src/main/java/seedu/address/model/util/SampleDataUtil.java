        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"), new DeadlineList(), Notes.getNewNotes(),
                    getTagSet("friends"), Favourite.NOT_FAVOURITE, HighImportance.NOT_HIGH_IMPORTANCE),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"), new DeadlineList(), Notes.getNewNotes(),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new DeadlineList(), Notes.getNewNotes(),
                    getTagSet("family"), Favourite.NOT_FAVOURITE, HighImportance.NOT_HIGH_IMPORTANCE),
